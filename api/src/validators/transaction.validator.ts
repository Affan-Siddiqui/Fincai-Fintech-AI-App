import { z } from "zod"
import { PaymentMethodEnum, RecurringIntervalEnum, TransactionTypeEnum } from "../enums/transaction.enum";

export const transactionIdSchema = z.string().trim().min(1, "Transaction ID is required");
...
export const baseTransactionSchema = z.object({
  ...
  nextRecurringDate : z.date().nullable(),
